...
static const int duree_survie[]={10000, 10000, 2, 3, 5, 10000, 3, 4, 4, 3, 10000, 10000};
static const int taille[]={-1, 1, 1, 2, 2, 0, 2, 4, 4, 5, 3, 2};
static const int taille_du_bide[]={0, 0, 1, 2, 1, 1, 3, 3, 4, 2, 0, 0};
